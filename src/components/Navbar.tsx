        ...
        <div className="navbar-inner">
          <div className="navbar-left">
            ...
            <Link to="/" className="logo-link">
              <img src="/logo_transparent.png" alt="내일 - 무장애지도" className="logo-img" width="100" height="30" loading="lazy" />
            </Link>
          </div>
      ...
      <div className={`sidebar-overlay ${menuOpen ? 'active' : ''}`} onClick={() => setMenuOpen(false)}>
        <div className={`sidebar ${menuOpen ? 'active' : ''}`} onClick={e => e.stopPropagation()}>
          <div className="sidebar-header">
            <img src="/logo_transparent.png" alt="내일 - 무장애지도" className="sidebar-logo" width="100" height="30" loading="lazy" />
